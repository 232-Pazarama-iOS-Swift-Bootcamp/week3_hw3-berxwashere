...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private func setupWindow(with windowScene: UIWindowScene) {
        ...
        let vc4 = UINavigationController(rootViewController: AudiobookViewController())
        
        vc1.title = "Podcasts"
        vc2.title = "Movies"
        vc3.title = "Musics"
        vc4.title = "Audiobooks"
  ...
  //      let navigationController = UINavigationController(rootViewController: vc1)
        ...
        tabBarController.setViewControllers([vc1, vc2, vc3, vc4], animated: false)
        
        guard let items = tabBarController.tabBar.items else {
            return
        }
        
        let images = ["mic", "video", "music.quarternote.3", "book"]
